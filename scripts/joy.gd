...
func _input(event):
	if get_parent().get_parent().get_node("Level").get_child_count() > 0 and not get_parent().get_parent().get_node("Level/level/Scoreboard/CanvasLayer").visible and not get_parent().get_parent().get_node("Level/level/loby").visible and get_parent().get_parent().get_node("CanvasLayer/change").visible:
...
func _physics_process(_delta):
	if get_parent().get_parent().get_node("Level").get_child_count() > 0:
		if not get_parent().get_parent().get_node("Level/level/Scoreboard/CanvasLayer").visible and not get_parent().get_parent().get_node("Level/level/loby").visible and get_parent().get_parent().get_node("CanvasLayer/change").visible:
