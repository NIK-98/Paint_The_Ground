...
@rpc("any_peer","call_local")
func explode_bomb(cell: int):
	BetterTerrain.set_cells(map, level.bomb_dict[cell], cell)
	BetterTerrain.update_terrain_cells(map, level.bomb_dict[cell])
